import { Size, TransitionOptions, Position, ExtendedPosition, PanoData, PanoDataProvider, SphereCorrection, Point, AbstractConfigurablePlugin, utils, Viewer, TypedEvent } from '@photo-sphere-viewer/core';
 ...
 * @deprecated
 */
type VirtualTourMarkerStyle = any;
/**
...
type VirtualTourPluginConfig = {
     ...
     */
    transitionOptions?: Pick<VirtualTourTransitionOptions, 'showLoader' | 'speed' | 'effect' | 'fadeIn' | 'rotation'> | ((toNode: VirtualTourNode, fromNode?: VirtualTourNode, fromLink?: VirtualTourLink) => VirtualTourTransitionOptions);
    /**
